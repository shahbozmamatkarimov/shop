  ...
  <main>
    <section>
      ...
      <div class="flex flex-col">
        <h1
          class="font-bold text-xl px-28 cursor-pointer ml-2 py-2 sticky top-0 z-40 bg-gray-200"
        >
          Airpods <i class="bx bx-down-arrow"></i>
        </h1>
          ...
          >
            <div class="overflow-x-hidden border rounded-2xl relative">
              <img
                ...
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6AbWuJSHjXyQA4EX8uUODojo6nHnUyulhxLZ7cYOO-0xSGnXS-cH_vzLbyGRtI1JWnjo&usqp=CAU"
              />
              <p
    ...
    <section>
      ...
      <div class="flex flex-col">
        <h1
          class="font-bold text-xl px-28 cursor-pointer ml-2 py-2 sticky top-0 z-40 bg-gray-200"
        >
          Smartpones <i class="bx bx-down-arrow"></i>
        </h1>
        <div class="relative m-3 flex flex-wrap mx-auto justify-center">
          <div
            v-for="i in 10"
          ...
          >
            <div class="overflow-x-hidden border rounded-2xl relative">
              <img
                ...
                src="https://assets-prd.ignimgs.com/2022/06/04/budget-smartphones-2-1654319490958.jpg"
              />
              <p
                class="absolute right-2 top-2 bg-white rounded-full p-2 cursor-pointer group"
              >
